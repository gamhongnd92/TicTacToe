...
public class TicTacToe {
	...
	private void initialize() {
		...
		JLabel lblCountX = new JLabel("0");
		lblCountX.setHorizontalAlignment(SwingConstants.CENTER);
		lblCountX.setFont(new Font("Tahoma", Font.BOLD, 20));
		panel_5.add(lblCountX, BorderLayout.CENTER);
		...
		JLabel lblCountO = new JLabel("0");
		lblCountO.setHorizontalAlignment(SwingConstants.CENTER);
		lblCountO.setFont(new Font("Tahoma", Font.BOLD, 20));
		panel_10.add(lblCountO, BorderLayout.CENTER);
